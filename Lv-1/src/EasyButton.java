...
public class EasyButton implements MouseListener, KeyListener{
	public static void main(String[] args) {
		EasyButton x = new EasyButton();
		x.showEasyButton();
	}
	/*
	...
	public void mouseClicked(MouseEvent e) {
		...
		speak("TickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTockTickTock");
